    ...
    public static Tuile[] genPiocheCarcasssonne() { //Création manuelle de toutes les tuiles pour carcassonne
        ...
        for (int i = 12; i < 14; i++) {
            pioche[i] = new TuileCarcassonne(new QuartierVille(), new Chemin(), new Chemin(),
                    new QuartierVille(), new Chemin(), true);
        }
        pioche[14] = new TuileCarcassonne(new QuartierVille(), new QuartierVille(),
                new Chemin(), new QuartierVille(), new QuartierVille(), false);
        pioche[15] = new TuileCarcassonne(new QuartierVille(), new QuartierVille(),
                new Pre(), new QuartierVille(), new QuartierVille(), true);
        for (int i = 16; i < 19; i++) {
            pioche[i] = new TuileCarcassonne(new QuartierVille(), new Chemin(), new Chemin(),
                    new QuartierVille(), new Chemin(), false);
        }
        for (int i = 19; i < 22; i++) {
        ...
        for (int i = 41; i < 44; i++) {
            pioche[i] = new TuileCarcassonne(new QuartierVille(), new QuartierVille(),
                    new Pre(), new QuartierVille(), new QuartierVille(), false);
        }
        for (int i = 44; i < 48; i++) {
            pioche[i] = new TuileCarcassonne(new Pre(), new Pre(), new Pre(), new Pre(), new Abbaye(), false);
        }
        for (int i = 48; i < 50; i++) {
            pioche[i] = new TuileCarcassonne(new Pre(), new Pre(), new Chemin(), new Pre(), new Abbaye(), false);
        }
        for (int i = 50; i < 53; i++) {
        ...
        pioche[62] = new TuileCarcassonne(new Pre(), new QuartierVille(), new Pre(), new QuartierVille(),
                new QuartierVille(), false);
        pioche[63] = new TuileCarcassonne(new QuartierVille(), new QuartierVille(), new QuartierVille(),
                new QuartierVille(), new QuartierVille(), true);
        for (int i = 64; i < 66; i++) {
            pioche[i] = new TuileCarcassonne(new QuartierVille(), new QuartierVille(),
                    new Chemin(), new QuartierVille(), new QuartierVille(), true);
        }
