...
import src.gui.View.TuileCarcassonneVue;
...
public class CarcassonneGame extends JFrame { // Cette partie se lance dans une fenêtre
    ...
    private void tournerView() { // Gestion du boutton tourner
        buttonTourner.addActionListener(e -> {
            ...
            System.out.println(tt.getHaut().getClass());
            System.out.println(tt.getDroite().getClass());
            System.out.println(tt.getBas().getClass());
            System.out.println(tt.getGauche().getClass());
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                if (placementOk) {// Si on peut placer la tuile :
                    if(Liste_Joueurs[joueurDuTour].getPion() > 0){
                        ...
                        "Voulez-vous placer un pion sur le case ? Vous en avez "+Liste_Joueurs[joueurDuTour].getPion(),
                        ...
                        if (clickbtn == JOptionPane.YES_OPTION) {
                            ...
                            Border bordera = BorderFactory.createLineBorder(Liste_Joueurs[joueurDuTour].getCouleur(), 2);
                            c.setBorder(bordera);
                        }
                    }
