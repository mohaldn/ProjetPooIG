...
public class PlateauView extends JPanel { // Une vue de plateau est un JPanel
    ...
    public PlateauView(Plateau p) { // //Constructeur d'un plateau
        ...
        System.out.println("Plateau.getxCentrePlateau = "+plateau.getxCentrePlateau());
        System.out.println("Plateau.getyCentrePlateau = "+plateau.getyCentrePlateau());
        System.out.println("Pla"+plateau.getPlateauActuel().length);
        System.out.println("Pla"+plateau.getPlateauActuel()[0].length);
